...
sel_algo_name = 'model_based_svr'
sel_result_file = './feat_sel_mats/'+data_name+'_'+sel_algo_name+'_sel_results_1_100_100x.mat'

# sel_result_file = '~/Desktop/'+data_name+'_'+algo_name+sel_algo_name+'_sel_results.mat'
...
for k_features in range(1,101):
    ...
    for i in range(1,101):
        print(i,'th repeated 80-20 hold out validation in', k_features, ' features')
        t0 = time.time()
